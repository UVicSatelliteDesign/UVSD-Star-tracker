...
public:
	...
	void get_orientation(vec<2>* centroids, int visible_stars, float fov, float safety_fov, vec<3> estimated_dir, vec<3>* forward, vec<3>* right, vec<3>* up, star** true_stars);
};
